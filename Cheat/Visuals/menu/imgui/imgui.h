...
inline int accent_color[4] = { 138, 168, 248, 255 };
/*
...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderFloat5(const char* label, float v[5], float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          SliderScalar_(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
